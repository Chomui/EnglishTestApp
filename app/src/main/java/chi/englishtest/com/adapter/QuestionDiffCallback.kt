...
class QuestionDiffCallback : DiffUtil.ItemCallback<QuestionWithAnswers>() {
    override fun areItemsTheSame(oldItem: QuestionWithAnswers, newItem: QuestionWithAnswers): Boolean {
        return oldItem.question?.id == newItem.question?.id
    }

    override fun areContentsTheSame(oldItem: QuestionWithAnswers, newItem: QuestionWithAnswers): Boolean {
